...
namespace AmblOn.State.API.Users
{
    ...
    public class EditPhoto
    {
        ...
        {
            return await stateBlob.WithStateHarness<UsersState, EditPhotoRequest, UsersStateHarness>(req, signalRMessages, log,
                async (harness, reqData, actReq) =>
            {
                ...
                await harness.EditPhoto(amblGraph, stateDetails.Username, stateDetails.EnterpriseLookup, reqData.Photo, reqData.AlbumID);
