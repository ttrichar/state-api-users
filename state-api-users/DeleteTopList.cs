...
namespace AmblOn.State.API.Users
{
    ...
    public class DeleteTopList
    {
        ...
        {
            return await stateBlob.WithStateHarness<AmblOnState, DeleteTopListRequest, AmblOnStateHarness>(req, signalRMessages, log,
                async (harness, reqData, actReq) =>
            {
                ...
                await harness.DeleteTopList(amblGraph, stateDetails.Username, stateDetails.EnterpriseAPIKey, reqData.TopListID);
