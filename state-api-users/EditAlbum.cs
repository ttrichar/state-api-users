...
namespace AmblOn.State.API.Users
{
    ...
    public class EditAlbum
    {
        ...
        {
            return await stateBlob.WithStateHarness<AmblOnState, EditAlbumRequest, AmblOnStateHarness>(req, signalRMessages, log,
                async (harness, reqData, actReq) =>
            {
                ...
                await harness.EditAlbum(amblGraph, stateDetails.Username, stateDetails.EnterpriseAPIKey, reqData.Album);
