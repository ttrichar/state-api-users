...
namespace AmblOn.State.API.Users
{
    ...
    public class DeleteMap
    {
        ...
        {
            return await stateBlob.WithStateHarness<UsersState, DeleteMapRequest, UsersStateHarness>(req, signalRMessages, log,
                async (harness, reqData, actReq) =>
            {
                ...
                //await harness.DeleteMap(amblGraph, stateDetails.Username, stateDetails.EnterpriseLookup, reqData.MapID);
