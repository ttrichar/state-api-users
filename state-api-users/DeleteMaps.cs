...
namespace AmblOn.State.API.Users
{
    ...
    public class DeleteMaps
    {
        ...
        #region Constructors
        public DeleteMaps(AmblOnGraph amblGraph)
        {
        ...
        {
            return await stateBlob.WithStateHarness<AmblOnState, DeleteMapsRequest, AmblOnStateHarness>(req, signalRMessages, log,
                async (harness, reqData, actReq) =>
            {
                log.LogInformation($"DeleteMaps");

                var stateDetails = StateUtils.LoadStateDetails(req);

                //await harness.DeleteMaps(amblGraph, stateDetails.Username, stateDetails.EnterpriseAPIKey, reqData.MapIDs);
