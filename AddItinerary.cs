...
namespace AmblOn.State.API.Users
{
    ...
    public class AddItinerary
    {
        ...
        {
            return await stateBlob.WithStateHarness<UsersState, AddItineraryRequest, UsersStateHarness>(req, signalRMessages, log,
                async (harness, reqData, actReq) =>
            {
                ...
                await harness.AddItinerary(amblGraph, stateDetails.Username, stateDetails.EnterpriseAPIKey, reqData.Itinerary);
